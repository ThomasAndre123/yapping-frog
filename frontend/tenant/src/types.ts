...
export interface Room { public_id: string; title: string; visibility: 'tenant' | 'private'; pinned: boolean; creator_name: string; last_message: string | null; unread_count: number }
